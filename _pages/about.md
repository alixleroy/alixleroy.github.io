...
I am currently doing my PhD in Applied and Computational Mathematics on efficient Bayesian approaches to inverse problem. I am supervised by [Jonas Latz](https://latzplacian.org/), [Des Higham](https://www.maths.ed.ac.uk/~dhigham/) and [Ben Leimkuhler](https://www.maths.ed.ac.uk/~bleimkuh/).

I work on: 
* **Adaptive stepsize Langevin dynamics** to obtain sampling methods that are more computationally efficient, see [my first paper](/publications/). 
...
I receive the support of the Maxwell Institute Graduate School in Mathematical Modelling, Analysis and Computation CDT ([MAC-MIGS](https://www.mac-migs.ac.uk)) and the Luxembourg National Research Fund ([FNR](https://www.fnr.lu/)). 
